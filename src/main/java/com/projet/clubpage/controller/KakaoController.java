...
import com.projet.clubpage.service.KakaoLoginService;
...
public class KakaoController {
    ...
    public CommonResponse<Object> getLoginCode(@RequestParam(value = "code")String code) {
// POST 방식으로 key=value 데이터를 요청 (카카오쪽으로)
        ...
        OAuthTokenRequest oAuthTokenRequest = kakaoLoginService.getTokenInfo(response);

        RestTemplate rt2 = new RestTemplate();

        HttpHeaders headers2 = new HttpHeaders();
        headers2.add("Authorization", "Bearer " + oAuthTokenRequest.getAccess_token());
        ...
        OAuthTokenResponse oAuthTokenResponse = kakaoLoginService.saveUserResponseToken(response2, oAuthTokenRequest);
